...
public class ReportAdminRestController {
   ...
   * @return ResponseEntity   - the response entity containing a success message if the report was
   * read successfully, an error message otherwise.
   */
  ...
  /**
   * Adds a comment to a report. The report is retrieved from the report repository using the id.
   * The comment is saved in the report comment repository.
   *
   * @param reportId - the id of the report to be commented on
   * @param content  - the content of the comment
   * @return ResponseEntity   - the response entity containing a success message if the comment was
   * added successfully, an error message otherwise.
   */
  @PostMapping("/api/admin/report/comment/{id}")
  public ResponseEntity commentReport(@PathVariable("id") Integer reportId,
